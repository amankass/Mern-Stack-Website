...
import { FaSearch, FaAccusoft } from 'react-icons/fa';
    ...
    <header className="bg-slate-300 shadow-md">
      <div className="flex justify-between items-center max-w-6xl mx-auto py-4 px-4"> {/* Added py-4 px-4 for padding */}
        ...
        <ul className="hidden sm:flex gap-4"> {/* Hide list on small screens */}
          <Link to="/">
            <li className="py-1 text-slate-950 hover:text-red-900 font-medium text-sm hover:text-red-900 
        ...
        <div className="relative">
          ...
          <ul
            ...
            <Link to='/Sign-In'>
            <li className="py-1 text-slate-950 hover:bg-red-900 hover:text-gray-200 font-medium rounded-lg m-1">Login</li>
            </Link>
            <Link to='/Sign-Up'>
            <li className="py-1 text-slate-950 hover:bg-red-900 hover:text-gray-200 font-medium rounded-lg m-1">SignUp</li>
            </Link>
            <Link to='/Profile'>
            <li className="py-1 text-slate-950 hover:bg-red-900 hover:text-gray-200 font-medium rounded-lg m-1">Profile</li>
            </Link>
          </ul>
        </div>
      </div>
