...
export default function HouseListing() {
  ...
  const [taxAmount, setTaxAmount] = useState(0); // State to store the tax amount
  ...
  useEffect(() => {
    const fetchListing = async () => {
      try {
        setLoading(true);
        const res = await fetch(`/api/houeslist/get/${params.listingId}`);
  ...
  //   if (listing) {
  //     const propertyTaxRate = 0.02; // Example property tax rate (2%)
  //     const listingPrice = listing.offer
